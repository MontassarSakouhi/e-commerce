...
const NewsLetter = () => {
    ...
    return (
        <div>
            {handleSubmit ? <div className="flex justify-center items-center flex-col mt-[80px] sm:mt-[130px] w-[350px] mx-auto">
                ...
                <form onSubmit={formik.handleSubmit} className="w-full">
                    ...
                    >
                        {loading ? <p>Loading   <span className="blinking-dots">
                            <span>.</span>
                            <span>.</span>
                            <span>.</span></span></p> : "I'm in"}
                    </button>
                </form>
            </div> : <div className='flex flex-col justify-center items-center mt-[80px] sm:mt-[130px] '  >
