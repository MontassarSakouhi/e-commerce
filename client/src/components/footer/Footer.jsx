      ...
      <div className="container mx-auto flex flex-row lg:flex-row justify-between">
        ...
        <div className="mb-6 lg:mb-0">
          ...
          <div className="flex flex-col sm:flex-row  sm:space-x-4">
            ...
            <FontAwesomeIcon icon={faTwitter} className="text-blue-400 text-xl cursor-pointer" />
            <FontAwesomeIcon icon={faLinkedin} className="text-blue-700 text-xl cursor-pointer" />
            <FontAwesomeIcon icon={faInstagram} className="text-pink-500 text-xl cursor-pointer" />
          </div>
        </div>
      </div>
      <FooterRights />
